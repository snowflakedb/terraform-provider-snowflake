...
- `token_accessor` (Block List, Max: 1) The legacy configuration for token accessor flows. If you are using the  OAuth authentication flows, use the dedicated `oauth...` fields instead. (see [below for nested schema](#nestedblock--token_accessor))
