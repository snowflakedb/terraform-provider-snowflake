...
- `log_event_level` (String) Specifies the severity level of telemetry events that should be ingested and made available in the active event table. Telemetry events at the specified level (and at more severe levels) are ingested. For more information, see [BCR 2229](https://docs.snowflake.com/en/release-notes/bcr-bundles/2026_02/bcr-2229). For more information, check [LOG_EVENT_LEVEL docs](https://docs.snowflake.com/en/sql-reference/parameters#log-event-level).
