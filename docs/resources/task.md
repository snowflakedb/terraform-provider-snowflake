...
!> **Warning** Due to conditional logic in Snowflake regarding required fields for a given type of task (serverless or not), please make sure you went through the [Snowflake documentation for tasks](https://docs.snowflake.com/en/user-guide/tasks-intro) to understand which fields are required for your use case.
