...
~> **Deprecation** This resource is deprecated and will be removed in a future major version release. Please use one of the new resources instead: [snowflake_storage_integration_aws](./storage_integration_aws) | [snowflake_storage_integration_azure](./storage_integration_azure) | [snowflake_storage_integration_gcs](./storage_integration_gcs). <deprecation>
