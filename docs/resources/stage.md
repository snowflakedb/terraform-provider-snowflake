...
~> **Deprecation** This resource is deprecated and will be removed in a future major version release. Please use one of the new resources instead: [snowflake_stage_internal](./stage_internal) | [snowflake_stage_external_s3](./stage_external_s3) | [snowflake_stage_external_s3_compatible](./stage_external_s3_compatible) | [snowflake_stage_external_gcs](./stage_external_gcs) | [snowflake_stage_external_azure](./stage_external_azure). <deprecation>
