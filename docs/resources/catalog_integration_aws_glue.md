...
- `refresh_interval_seconds` (Number) (Default: `30`) Specifies the number of seconds to wait between attempts to poll the external Iceberg catalog for metadata updates for automated refresh.
