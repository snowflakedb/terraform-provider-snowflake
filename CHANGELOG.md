...
## [2.18.0](https://github.com/snowflakedb/terraform-provider-snowflake/compare/v2.17.0...v2.18.0) (2026-06-19)
...
* add snowflake_iceberg_table_from_files resource (preview) ([#4842](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4842)) ([4f91e6d](https://github.com/snowflakedb/terraform-provider-snowflake/commit/4f91e6d299bd4bdcca22d83b95ceea1749084338))
* Add snowflake_storage_lifecycle_policy resource ([#4852](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4852)) ([ea2a417](https://github.com/snowflakedb/terraform-provider-snowflake/commit/ea2a417a6306912529cc6dbc59af88b21aa543ee))
* Add storage lifecycle policies data source ([#4879](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4879)) ([c828ef4](https://github.com/snowflakedb/terraform-provider-snowflake/commit/c828ef48200910dbce1fb3ce3ec50514d139a684))
...
* Allow granting ownership on agents ([#4859](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4859)) ([fdbc9b4](https://github.com/snowflakedb/terraform-provider-snowflake/commit/fdbc9b40cdc81f16d205133f4bbf297800828e6a)), closes [#4844](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4844)
* create api integration amazon api gateway resource ([#4822](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4822)) ([b349477](https://github.com/snowflakedb/terraform-provider-snowflake/commit/b3494779385000ba671bb1115f9900b394bcf58e))
* create api integration azure api management resource ([#4860](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4860)) ([466a868](https://github.com/snowflakedb/terraform-provider-snowflake/commit/466a868a5bdfacc628582c0e241b4455e683cb8c))
* create api integration git repository GitHub app resource ([#4873](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4873)) ([94b1f75](https://github.com/snowflakedb/terraform-provider-snowflake/commit/94b1f7525952a1030bcb5743c7c316cfac5477e5))
* create api integration google cloud api gateway resource ([#4869](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4869)) ([4995d6b](https://github.com/snowflakedb/terraform-provider-snowflake/commit/4995d6bdb5f5ca3336bc4099231662b0c4252567))
...
* Rename in hierarchies experiment ([#4825](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4825)) ([723dd3d](https://github.com/snowflakedb/terraform-provider-snowflake/commit/723dd3d9c5ce7ee4a25528faeadd8e146a699e85))
* Support tagging iceberg table columns in tag_association ([#4886](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4886)) ([93144b8](https://github.com/snowflakedb/terraform-provider-snowflake/commit/93144b846b0664f01d67f0727ae13d81e27c9987))
...
* Add missing Iceberg table ALTER integration tests and SDK fixes ([#4851](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4851)) ([a0087c9](https://github.com/snowflakedb/terraform-provider-snowflake/commit/a0087c9f5eca929b5646dade9242e2ee3c6e687e))
...
* Add new provider factory ([#4866](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4866)) ([2e0b2cf](https://github.com/snowflakedb/terraform-provider-snowflake/commit/2e0b2cf714fc8a15ce9c16b1b81d572fc5b79e27))
* Add object and parts exclusion filters to the generator commons ([#4848](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4848)) ([02a28c3](https://github.com/snowflakedb/terraform-provider-snowflake/commit/02a28c3c5758936374732867e34a63d69d33de0e))
...
* Add SDK integration tests for CreateFromDeltaLake iceberg table ([#4831](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4831)) ([c48f786](https://github.com/snowflakedb/terraform-provider-snowflake/commit/c48f786c71f4344f37acb61c6efc6fb5855eeabf))
...
* Add SDK support for SYSTEM$GET_ICEBERG_TABLE_INFORMATION system function ([#4841](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4841)) ([36ba95d](https://github.com/snowflakedb/terraform-provider-snowflake/commit/36ba95da623fac49ab270a2e5dcb9d0e6ee768f7))
...
* bump Go dependencies ([#4829](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4829)) ([611f95b](https://github.com/snowflakedb/terraform-provider-snowflake/commit/611f95bcd195f60ca4763110a9ebc55762b14770))
* Close every new client created in client integration tests ([#4839](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4839)) ([c5e54c4](https://github.com/snowflakedb/terraform-provider-snowflake/commit/c5e54c4a45253aec18a3b2298393122efa39f0ed))
...
* Introduce enabled/disabled generation parts behavior ([#4849](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4849)) ([dea80b6](https://github.com/snowflakedb/terraform-provider-snowflake/commit/dea80b6120e4548f8cd191bc73eeca6f91015efc))
* Introduce interface for generation part names ([#4858](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4858)) ([422a73f](https://github.com/snowflakedb/terraform-provider-snowflake/commit/422a73f49f5b10ed5c6714c1e7fbfcfef8389315))
* Isolate /ok-to-test concurrency group per PR ([#4878](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4878)) ([1eb17ae](https://github.com/snowflakedb/terraform-provider-snowflake/commit/1eb17ae7b1dca8b8194fa91509d9f6b746d856f6))
* Move objects to SDK generator - database roles ([#4850](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4850)) ([c85adee](https://github.com/snowflakedb/terraform-provider-snowflake/commit/c85adee78701afaa811b3f95f741ba149bad9f38))
* Move objects to SDK generator - databases ([#4880](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4880)) ([63e9ebe](https://github.com/snowflakedb/terraform-provider-snowflake/commit/63e9ebe21a750a7700b46d4b6028ef74c8761dcd))
* Move objects to SDK generator - warehouses ([#4865](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4865)) ([3cecf4a](https://github.com/snowflakedb/terraform-provider-snowflake/commit/3cecf4aaa8c1aabe2739c28f2d62163125914211))
...
* Rename in hierarchies experiment - 3-level hierarchy in snowflake_table ([#4881](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4881)) ([8dfc586](https://github.com/snowflakedb/terraform-provider-snowflake/commit/8dfc586b59a8288fc25f311ba9d7d8518c5a12df))
...
* Do not normalize Iceberg table object type in GET_TAG ([#4867](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4867)) ([da46936](https://github.com/snowflakedb/terraform-provider-snowflake/commit/da46936203f1e4fd92ff36824cb6e157a801a2d8))
* grants redesign doc template + run `make docs` to update md ([#4864](https://github.com/snowflakedb/terraform-provider-snowflake/issues/4864)) ([01c633e](https://github.com/snowflakedb/terraform-provider-snowflake/commit/01c633e70e79b1411f89d4970b2a1c430ec49f91))
