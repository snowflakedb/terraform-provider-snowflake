...
This feature is works independently of the `GRANTS_IMPORT_VALIDATION` flag.
...
This feature is works independently of the `GRANTS_STRICT_PRIVILEGE_MANAGEMENT` flag.
