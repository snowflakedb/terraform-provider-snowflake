...
var (
	...
	accountParametersCustomDiff = ParametersCustomDiff(
		...
		parameter[sdk.AccountParameter]{sdk.AccountParameterDataRetentionTimeInDays, valueTypeString, sdk.ParameterTypeAccount},
		...
		parameter[sdk.AccountParameter]{sdk.AccountParameterMaxDataExtensionTimeInDays, valueTypeString, sdk.ParameterTypeAccount}, // TODO: Int?
...
func init() {
	...
	AccountParameterFields := []parameterDef[sdk.AccountParameter]{
		...
		{Name: sdk.AccountParameterDefaultNotebookComputePoolCpu, Type: schema.TypeString, Description: "Sets the preferred CPU compute pool used for [Notebooks on CPU Container Runtime](https://docs.snowflake.com/en/developer-guide/snowflake-ml/notebooks-on-spcs)."},
		{Name: sdk.AccountParameterDefaultNotebookComputePoolGpu, Type: schema.TypeString, Description: "Sets the preferred GPU compute pool used for [Notebooks on GPU Container Runtime](https://docs.snowflake.com/en/developer-guide/snowflake-ml/notebooks-on-spcs)."},
		...
		// TODO [SNOW-1850370]: Add DiffSuppress with NormalizeAndCompare(sdk.ParseSchemaObjectIdentifier) as currently sdk.SchemaObjectIdentifier is not comparable
		...
		{Name: sdk.AccountParameterTimestampTypeMapping, Type: schema.TypeString, ValidateDiag: sdkValidation(sdk.ToTimestampTypeMapping), DiffSuppress: NormalizeAndCompare(sdk.ToTimestampTypeMapping), Description: fmt.Sprintf("Specifies the TIMESTAMP_* variation that the TIMESTAMP data type alias maps to. Valid values are (case-insensitive): %s.", sdk.AllTimestampTypeMappings)},
