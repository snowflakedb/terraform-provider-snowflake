...
var (
	...
	accountParametersCustomDiff = ParametersCustomDiff(
		...
		parameter[sdk.AccountParameter]{sdk.AccountParameterEnablePerAccountAppServicePrivatelinkUrl, valueTypeBool, sdk.ParameterTypeAccount},
		...
		parameter[sdk.AccountParameter]{sdk.AccountParameterCortexCodeCliDailyEstCreditLimitPerUser, valueTypeInt, sdk.ParameterTypeAccount},
		parameter[sdk.AccountParameter]{sdk.AccountParameterCortexCodeDesktopDailyEstCreditLimitPerUser, valueTypeInt, sdk.ParameterTypeAccount},
		parameter[sdk.AccountParameter]{sdk.AccountParameterCortexCodeSnowsightDailyEstCreditLimitPerUser, valueTypeInt, sdk.ParameterTypeAccount},
		...
		parameter[sdk.AccountParameter]{sdk.AccountParameterDefaultStreamlitComputePool, valueTypeString, sdk.ParameterTypeAccount},
		...
		parameter[sdk.AccountParameter]{sdk.AccountParameterLogEventLevel, valueTypeString, sdk.ParameterTypeAccount},
...
func init() {
	...
	AccountParameterFields := []parameterDef[sdk.AccountParameter]{
		...
		{Name: sdk.AccountParameterDefaultStreamlitComputePool, Type: schema.TypeString, ValidateDiag: IsValidIdentifier[sdk.AccountObjectIdentifier](), DiffSuppress: suppressIdentifierQuoting, Description: blocklistedCharactersFieldDescription("Specifies the name of the default compute pool to use when creating container-runtime Streamlit apps.")},
...
func handleAccountParameterRead(d *schema.ResourceData, accountParameters []*sdk.Parameter) error {
	for _, p := range accountParameters {
		...
		case string(sdk.AccountParameterAbortDetachedQuery),
			...
			string(sdk.AccountParameterEnablePerAccountAppServicePrivatelinkUrl),
		...
		case string(sdk.AccountParameterClientEncryptionKeySize),
			...
			string(sdk.AccountParameterCortexCodeCliDailyEstCreditLimitPerUser),
			string(sdk.AccountParameterCortexCodeDesktopDailyEstCreditLimitPerUser),
			string(sdk.AccountParameterCortexCodeSnowsightDailyEstCreditLimitPerUser),
		...
		case string(sdk.AccountParameterActivePythonProfiler),
			...
			string(sdk.AccountParameterDefaultStreamlitComputePool),
			...
			string(sdk.AccountParameterLogEventLevel),
...
func handleAccountParametersCreate(d *schema.ResourceData, parameters *sdk.AccountParameters) diag.Diagnostics {
	diags := JoinDiags(
		...
		handleParameterCreate(d, sdk.AccountParameterEnablePerAccountAppServicePrivatelinkUrl, &parameters.EnablePerAccountAppServicePrivatelinkUrl),
		...
		handleParameterCreate(d, sdk.AccountParameterCortexCodeCliDailyEstCreditLimitPerUser, &parameters.CortexCodeCliDailyEstCreditLimitPerUser),
		handleParameterCreate(d, sdk.AccountParameterCortexCodeDesktopDailyEstCreditLimitPerUser, &parameters.CortexCodeDesktopDailyEstCreditLimitPerUser),
		handleParameterCreate(d, sdk.AccountParameterCortexCodeSnowsightDailyEstCreditLimitPerUser, &parameters.CortexCodeSnowsightDailyEstCreditLimitPerUser),
		...
		handleParameterCreate(d, sdk.AccountParameterDefaultStreamlitComputePool, &parameters.DefaultStreamlitComputePool),
		...
		handleParameterCreateWithMapping(d, sdk.AccountParameterLogEventLevel, &parameters.LogEventLevel, sdk.ToLogLevel),
...
func handleAccountParametersUpdate(d *schema.ResourceData, set *sdk.AccountParameters, unset *sdk.AccountParametersUnset) diag.Diagnostics {
	diags := JoinDiags(
		...
		handleParameterUpdate(d, sdk.AccountParameterEnablePerAccountAppServicePrivatelinkUrl, &set.EnablePerAccountAppServicePrivatelinkUrl, &unset.EnablePerAccountAppServicePrivatelinkUrl),
		...
		handleParameterUpdate(d, sdk.AccountParameterCortexCodeCliDailyEstCreditLimitPerUser, &set.CortexCodeCliDailyEstCreditLimitPerUser, &unset.CortexCodeCliDailyEstCreditLimitPerUser),
		handleParameterUpdate(d, sdk.AccountParameterCortexCodeDesktopDailyEstCreditLimitPerUser, &set.CortexCodeDesktopDailyEstCreditLimitPerUser, &unset.CortexCodeDesktopDailyEstCreditLimitPerUser),
		handleParameterUpdate(d, sdk.AccountParameterCortexCodeSnowsightDailyEstCreditLimitPerUser, &set.CortexCodeSnowsightDailyEstCreditLimitPerUser, &unset.CortexCodeSnowsightDailyEstCreditLimitPerUser),
		...
		handleParameterUpdate(d, sdk.AccountParameterDefaultStreamlitComputePool, &set.DefaultStreamlitComputePool, &unset.DefaultStreamlitComputePool),
		...
		handleParameterUpdateWithMapping(d, sdk.AccountParameterLogEventLevel, &set.LogEventLevel, &unset.LogEventLevel, sdk.ToLogLevel),
