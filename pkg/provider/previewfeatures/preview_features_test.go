...
func Test_StringToFeature(t *testing.T) {
	...
	valid := []test{
		...
		{input: "snowflake_external_gcs_stage_resource", want: ExternalGcsStageResource},
		{input: "snowflake_external_s3_stage_resource", want: ExternalS3StageResource},
		{input: "snowflake_external_s3_compatible_stage_resource", want: ExternalS3CompatStageResource},
		...
		{input: "snowflake_internal_stage_resource", want: InternalStageResource},
