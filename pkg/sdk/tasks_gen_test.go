...
func TestTasks_Alter(t *testing.T) {
	...
	// validation adjusted manually to include TargetCompletionInterval
	t.Run("validation: at least one of the fields [opts.Set.Warehouse opts.Set.UserTaskManagedInitialWarehouseSize opts.Set.Schedule opts.Set.Config opts.Set.AllowOverlappingExecution opts.Set.UserTaskTimeoutMs opts.Set.SuspendTaskAfterNumFailures opts.Set.ErrorIntegration opts.Set.Comment opts.Set.SessionParameters opts.Set.TaskAutoRetryAttempts opts.Set.UserTaskMinimumTriggerIntervalInSeconds opts.Set.TargetCompletionInterval] should be set", func(t *testing.T) {
		opts := defaultOpts()
		opts.Set = &TaskSet{}
		assertOptsInvalidJoinedErrors(t, opts, errAtLeastOneOf("AlterTaskOptions.Set", "Warehouse", "UserTaskManagedInitialWarehouseSize", "Schedule", "Config", "AllowOverlappingExecution", "UserTaskTimeoutMs", "SuspendTaskAfterNumFailures", "ErrorIntegration", "Comment", "SessionParameters", "TaskAutoRetryAttempts", "UserTaskMinimumTriggerIntervalInSeconds", "TargetCompletionInterval"))
	})
