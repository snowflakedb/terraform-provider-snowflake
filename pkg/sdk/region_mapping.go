...
// taken from https://docs.snowflake.com/en/user-guide/admin-account-identifier#non-vps-account-locator-formats-by-cloud-platform-and-region
var regionMapping = map[string]string{
	// AWS
	"aws_us_west_2":            "", // left blank as this is the default
	"aws_us_gov_west_2":        "us-gov-west-2.aws",
	"aws_us_gov_west_1_fhplus": "fhplus.us-gov-west-1.aws",
	"aws_us_gov_west_1_dod":    "dod.us-gov-west-1.aws",
	"aws_us_east_2":            "us-east-2.aws",
	"aws_us_east_1":            "us-east-1",
	"aws_us_gov_east_1":        "us-gov-east-1.aws",
	"aws_us_gov_east_1_fhplus": "fhplus.us-gov-east-1.aws",
	"aws_ca_central_1":         "ca-central-1.aws",
	"aws_sa_east_1":            "sa-east-1.aws",
	"aws_af_south_1":           "af-south-1.aws",
	"aws_eu_west_1":            "eu-west-1",
	"aws_eu_west_2":            "eu-west-2.aws",
	"aws_eu_west_3":            "eu-west-3.aws",
	"aws_eu_central_1":         "eu-central-1",
	"aws_eu_central_2":         "eu-central-2.aws",
	...
	"azure_koreacentral":         "korea-central.azure",
