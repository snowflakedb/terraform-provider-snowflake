...
func (s *CreateExternalAccessIntegrationRequest) WithAllowedApiAuthenticationIntegrations(integrations []AccountObjectIdentifier) *CreateExternalAccessIntegrationRequest {
	s.AllowedApiAuthenticationIntegrations = integrations
	return s
}
...
func (s *ExternalAccessIntegrationSetRequest) WithAllowedApiAuthenticationIntegrations(integrations []AccountObjectIdentifier) *ExternalAccessIntegrationSetRequest {
	s.AllowedApiAuthenticationIntegrations = integrations
	return s
}
