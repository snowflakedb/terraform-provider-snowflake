...
type Client struct {
	...
	DataMetricFunctionExpectations DataMetricFunctionExpectations
...
func (c *Client) initialize() {
	...
	c.DataMetricFunctionExpectations = &dataMetricFunctionExpectations{client: c}
	c.DataMetricFunctions = &dataMetricFunctions{client: c}
