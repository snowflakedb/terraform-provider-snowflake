...
func (opts *AlterHybridTableOptions) validate() error {
	...
	if valueSet(opts.Set) {
		if !anyValueSet(opts.Set.DataRetentionTimeInDays, opts.Set.MaxDataExtensionTimeInDays, opts.Set.EnableSchemaEvolution, opts.Set.Contact, opts.Set.Comment, opts.Set.RowTimestamp) {
			errs = append(errs, errAtLeastOneOf("AlterHybridTableOptions.Set", "DataRetentionTimeInDays", "MaxDataExtensionTimeInDays", "EnableSchemaEvolution", "Contact", "Comment", "RowTimestamp"))
		}
	}
	return JoinErrors(errs...)
}
