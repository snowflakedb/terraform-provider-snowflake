...
type LegacyConfigDTO struct {
	...
	CrlOnDiskCacheDisabled            *bool               `toml:"crlondiskcachedisabled"`
	CrlHTTPClientTimeout              *int                `toml:"crlhttpclienttimeout"`
	DisableSamlURLCheck               *bool               `toml:"disablesamlurlcheck"`
}
