...
func TestProcedures_CreateForJava(t *testing.T) {
	...
	// Minimal valid CreateForJavaProcedureOptions
	defaultOpts := func() *CreateForJavaProcedureOptions {
		return &CreateForJavaProcedureOptions{
			...
			Packages: []ProcedurePackage{
				{
					ProcedurePackage: "com.snowflake:snowpark:1.2.0",
				},
			},
			RuntimeVersion: "1.8",
		}
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateForJavaProcedureOptions)(nil)
...
func TestProcedures_CreateForJavaScript(t *testing.T) {
	// adjusted manually
	id := randomSchemaObjectIdentifier()
	// Minimal valid CreateForJavaScriptProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateForJavaScriptProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
...
func TestProcedures_CreateForPython(t *testing.T) {
	...
	// Minimal valid CreateForPythonProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateForPythonProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("all options - old data types", func(t *testing.T) {
		...
		opts.Packages = []ProcedurePackage{
			...
			{
				ProcedurePackage: "pandas",
			},
		}
		opts.Imports = []ProcedureImport{
			{
				ProcedureImport: "numpy",
			},
			{
				ProcedureImport: "pandas",
			},
		}
		opts.Handler = "udf"
		opts.ExternalAccessIntegrations = []AccountObjectIdentifier{
...
func TestProcedures_CreateForScala(t *testing.T) {
	// adjusted manually
	id := randomSchemaObjectIdentifier()
	// Minimal valid CreateForScalaProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateForScalaProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("all options - old data types", func(t *testing.T) {
		...
		opts.Imports = []ProcedureImport{
			{
				ProcedureImport: "@udf_libs/echohandler.jar",
			},
		}
...
func TestProcedures_CreateForSQL(t *testing.T) {
	// adjusted manually
	id := randomSchemaObjectIdentifier()
	// Minimal valid CreateForSQLProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateForSQLProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
...
func TestProcedures_Alter(t *testing.T) {
	...
	// Minimal valid AlterProcedureOptions
	...
	t.Run("validation: at least one of the fields [opts.Set.Comment opts.Set.ExternalAccessIntegrations opts.Set.SecretsList opts.Set.AutoEventLogging opts.Set.EnableConsoleOutput opts.Set.LogLevel opts.Set.LogEventLevel opts.Set.MetricLevel opts.Set.TraceLevel] should be set", func(t *testing.T) {
		opts := defaultOpts()
		opts.Set = &ProcedureSet{}
		assertOptsInvalidJoinedErrors(t, opts, errAtLeastOneOf("AlterProcedureOptions.Set", "Comment", "ExternalAccessIntegrations", "SecretsList", "AutoEventLogging", "EnableConsoleOutput", "LogLevel", "LogEventLevel", "MetricLevel", "TraceLevel"))
	})

	t.Run("validation: at least one of the fields [opts.Unset.Comment opts.Unset.ExternalAccessIntegrations opts.Unset.AutoEventLogging opts.Unset.EnableConsoleOutput opts.Unset.LogLevel opts.Unset.LogEventLevel opts.Unset.MetricLevel opts.Unset.TraceLevel] should be set", func(t *testing.T) {
		opts := defaultOpts()
		opts.Unset = &ProcedureUnset{}
		assertOptsInvalidJoinedErrors(t, opts, errAtLeastOneOf("AlterProcedureOptions.Unset", "Comment", "ExternalAccessIntegrations", "AutoEventLogging", "EnableConsoleOutput", "LogLevel", "LogEventLevel", "MetricLevel", "TraceLevel"))
	})
...
func TestProcedures_Drop(t *testing.T) {
	...
	// Minimal valid DropProcedureOptions
...
func TestProcedures_Show(t *testing.T) {
	// Minimal valid ShowProcedureOptions
...
func TestProcedures_Describe(t *testing.T) {
	// adjusted manually
	id := randomSchemaObjectIdentifierWithArguments(DataTypeVARCHAR, DataTypeNumber)
	// Minimal valid DescribeProcedureOptions
...
func TestProcedures_Call(t *testing.T) {
	// adjusted manually
	id := randomSchemaObjectIdentifier()
	// Minimal valid CallProcedureOptions
...
func TestProcedures_CreateAndCallForJava(t *testing.T) {
	...
	// Minimal valid CreateAndCallForJavaProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateAndCallForJavaProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("validation: exactly one field from [opts.Arguments.ArgDataTypeOld opts.Arguments.ArgDataType] should be present", func(t *testing.T) {
		...
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("CreateAndCallForJavaProcedureOptions.Arguments", "ArgDataTypeOld", "ArgDataType"))
	})
	...
	t.Run("no arguments", func(t *testing.T) {
		...
		opts.Packages = []ProcedurePackage{
			{
				ProcedurePackage: "com.snowflake:snowpark:latest",
			},
		}
		opts.Handler = "TestFunc.echoVarchar"
...
func TestProcedures_CreateAndCallForScala(t *testing.T) {
	// adjusted manually
	id := randomAccountObjectIdentifier()
	// Minimal valid CreateAndCallForScalaProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateAndCallForScalaProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("validation: [opts.Packages] should be set", func(t *testing.T) {
		opts := defaultOpts()
		opts.Packages = nil
		assertOptsInvalidJoinedErrors(t, opts, errNotSet("CreateAndCallForScalaProcedureOptions", "Packages"))
	})
	...
	t.Run("validation: exactly one field from [opts.Arguments.ArgDataTypeOld opts.Arguments.ArgDataType] should be present", func(t *testing.T) {
		...
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("CreateAndCallForScalaProcedureOptions.Arguments", "ArgDataTypeOld", "ArgDataType"))
	})
...
func TestProcedures_CreateAndCallForJavaScript(t *testing.T) {
	// adjusted manually
	id := randomAccountObjectIdentifier()
	// Minimal valid CreateAndCallForJavaScriptProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateAndCallForJavaScriptProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("validation: exactly one field from [opts.ResultDataTypeOld opts.ResultDataType] should be present", func(t *testing.T) {
		opts := defaultOpts()
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("CreateAndCallForJavaScriptProcedureOptions", "ResultDataTypeOld", "ResultDataType"))
	})

	t.Run("validation: exactly one field from [opts.ResultDataTypeOld opts.ResultDataType] should be present - more present", func(t *testing.T) {
		opts := defaultOpts()
		opts.ResultDataTypeOld = DataTypeFloat
		opts.ResultDataType = dataTypeFloat
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("CreateAndCallForJavaScriptProcedureOptions", "ResultDataTypeOld", "ResultDataType"))
	...
	t.Run("validation: exactly one field from [opts.Arguments.ArgDataTypeOld opts.Arguments.ArgDataType] should be present", func(t *testing.T) {
		...
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("CreateAndCallForJavaScriptProcedureOptions.Arguments", "ArgDataTypeOld", "ArgDataType"))
	})
...
func TestProcedures_CreateAndCallForPython(t *testing.T) {
	// adjusted manually
	id := randomAccountObjectIdentifier()
	// Minimal valid CreateAndCallForPythonProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateAndCallForPythonProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("validation: [opts.Packages] should be set", func(t *testing.T) {
		opts := defaultOpts()
		opts.Packages = nil
		assertOptsInvalidJoinedErrors(t, opts, errNotSet("CreateAndCallForPythonProcedureOptions", "Packages"))
	})
	...
	t.Run("validation: exactly one field from [opts.Arguments.ArgDataTypeOld opts.Arguments.ArgDataType] should be present", func(t *testing.T) {
		...
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("CreateAndCallForPythonProcedureOptions.Arguments", "ArgDataTypeOld", "ArgDataType"))
	})
	...
	t.Run("no arguments", func(t *testing.T) {
		...
		opts.Packages = []ProcedurePackage{
			{
				ProcedurePackage: "snowflake-snowpark-python",
			},
		}
		opts.Handler = "udf"
		opts.ProcedureName = id
...
func TestProcedures_CreateAndCallForSQL(t *testing.T) {
	// adjusted manually
	id := randomAccountObjectIdentifier()
	// Minimal valid CreateAndCallForSQLProcedureOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateAndCallForSQLProcedureOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("validation: exactly one field from [opts.Arguments.ArgDataTypeOld opts.Arguments.ArgDataType] should be present", func(t *testing.T) {
		...
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("CreateAndCallForSQLProcedureOptions.Arguments", "ArgDataTypeOld", "ArgDataType"))
	})
