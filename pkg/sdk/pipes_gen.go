...
type Pipes interface {
	Create(ctx context.Context, request *CreatePipeRequest) error
	Alter(ctx context.Context, request *AlterPipeRequest) error
	Drop(ctx context.Context, request *DropPipeRequest) error
	DropSafely(ctx context.Context, id SchemaObjectIdentifier) error
	Show(ctx context.Context, request *ShowPipeRequest) ([]Pipe, error)
	...
	Describe(ctx context.Context, id SchemaObjectIdentifier) (*PipeDetail, error)
}
