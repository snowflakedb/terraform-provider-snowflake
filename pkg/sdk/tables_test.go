...
func TestTableCreate(t *testing.T) {
	...
	t.Run("with skip file x", func(t *testing.T) {
		...
		request := NewCreateTableRequest(id, columns).
			WithStageCopyOptions(*NewLegacyCopyOptionsRequest().WithOnError(*NewStageCopyOnErrorOptionsRequest().WithSkipFileX(5)))
	...
	t.Run("with skip file x %", func(t *testing.T) {
		...
		request := NewCreateTableRequest(id, columns).
			WithStageCopyOptions(*NewLegacyCopyOptionsRequest().WithOnError(*NewStageCopyOnErrorOptionsRequest().WithSkipFileXPercent(10)))
