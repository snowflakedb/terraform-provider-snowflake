...
func TestApplications_Create(t *testing.T) {
	...
	// Minimal valid CreateApplicationOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*CreateApplicationOptions)(nil)
	...
	t.Run("validation: valid identifier for [opts.PackageName]", func(t *testing.T) {
		opts := defaultOpts()
		opts.PackageName = emptyAccountObjectIdentifier
		assertOptsInvalidJoinedErrors(t, opts, ErrInvalidObjectIdentifier)
	})

	t.Run("validation: exactly one field from [opts.Version.VersionDirectory opts.Version.VersionAndPatch] should be present", func(t *testing.T) {
		opts := defaultOpts()
	...
	t.Run("validation: exactly one field from [opts.Version.VersionDirectory opts.Version.VersionAndPatch] should be present - more present", func(t *testing.T) {
		opts := defaultOpts()
		opts.Version = &ApplicationVersion{
	...
	t.Run("basic", func(t *testing.T) {
		opts := defaultOpts()
		assertOptsValidAndSQLEquals(t, opts, `CREATE APPLICATION %s FROM APPLICATION PACKAGE %s`, id.FullyQualifiedName(), pid.FullyQualifiedName())
	})
...
func TestApplications_Drop(t *testing.T) {
	id := randomAccountObjectIdentifier()
	// Minimal valid DropApplicationOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*DropApplicationOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("basic", func(t *testing.T) {
		opts := defaultOpts()
		assertOptsValidAndSQLEquals(t, opts, `DROP APPLICATION %s`, id.FullyQualifiedName())
	})
...
func TestApplications_Alter(t *testing.T) {
	id := randomAccountObjectIdentifier()
	// Minimal valid AlterApplicationOptions
	...
	t.Run("validation: nil options", func(t *testing.T) {
		opts := (*AlterApplicationOptions)(nil)
		assertOptsInvalidJoinedErrors(t, opts, ErrNilOptions)
	})
	...
	t.Run("validation: exactly one field from [opts.Set opts.Unset opts.Upgrade opts.UpgradeVersion opts.UnsetReferences opts.SetTags opts.UnsetTags] should be present", func(t *testing.T) {
		opts := defaultOpts()
	...
	t.Run("validation: exactly one field from [opts.Set opts.Unset opts.Upgrade opts.UpgradeVersion opts.UnsetReferences opts.SetTags opts.UnsetTags] should be present - more present", func(t *testing.T) {
		opts := defaultOpts()
	...
	t.Run("validation: exactly one field from [opts.UpgradeVersion.VersionDirectory opts.UpgradeVersion.VersionAndPatch] should be present", func(t *testing.T) {
		opts := defaultOpts()
		opts.UpgradeVersion = &ApplicationVersion{}
		assertOptsInvalidJoinedErrors(t, opts, errExactlyOneOf("AlterApplicationOptions.UpgradeVersion", "VersionDirectory", "VersionAndPatch"))
	})

	t.Run("validation: exactly one field from [opts.UpgradeVersion.VersionDirectory opts.UpgradeVersion.VersionAndPatch] should be present - more present", func(t *testing.T) {
		opts := defaultOpts()
		opts.UpgradeVersion = &ApplicationVersion{
			VersionAndPatch: &VersionAndPatch{
				Version: "1.0",
...
func TestApplications_Describe(t *testing.T) {
	id := randomAccountObjectIdentifier()
	// Minimal valid DescribeApplicationOptions
