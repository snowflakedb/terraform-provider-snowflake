...
func SetAndUnsetAccountParametersTest(t *testing.T, client *sdk.Client) {
	t.Helper()
	...
	err := client.OrganizationAccounts.Alter(context.Background(), sdk.NewAlterOrganizationAccountRequest().WithSet(*sdk.NewOrganizationAccountSetRequest().WithParameters(sdk.AccountParameters{
	...
	parameters, err := client.Accounts.ShowParameters(context.Background())
	require.NoError(t, err)
	...
	err = client.OrganizationAccounts.Alter(context.Background(), sdk.NewAlterOrganizationAccountRequest().WithUnset(*sdk.NewOrganizationAccountUnsetRequest().WithParameters(sdk.AccountParametersUnset{
		AbortDetachedQuery:                               sdk.Bool(true),
...
func assertParameterValueSetOnAccount(t *testing.T, parameters []*sdk.Parameter, parameterKey string, parameterValue string) {
	t.Helper()
...
func assertParameterIsDefault(t *testing.T, parameters []*sdk.Parameter, parameterKey string) {
	t.Helper()
	param, err := collections.FindFirst(parameters, func(parameter *sdk.Parameter) bool { return parameter.Key == parameterKey })
...
func assertThatPolicyIsSetOnAccount(t *testing.T, id sdk.SchemaObjectIdentifier) {
	t.Helper()
