...
//		err := client.Listings.Create(ctx, sdk.NewCreateListingRequest(id, testManifest))
...
//
//		err = client.Listings.Alter(ctx, sdk.NewAlterListingRequest(id).
//			WithAlterListingAs(*sdk.NewAlterListingAsRequest(testManifest).
//				WithPublish(true).
//				WithReview(true).
//				WithComment(comment),
//			))
...
//
//		err := client.Listings.Create(ctx, sdk.NewCreateListingRequest(id, testManifest).WithComment(comment))
//		assert.NoError(t, err)
//		t.Cleanup(testClientHelper().Listing.DropFunc(id))
//
//		// TODO: Assert
