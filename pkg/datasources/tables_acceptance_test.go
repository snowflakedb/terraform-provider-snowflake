		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.snowflake_tables.in_schema", "database", tableId.DatabaseName()),
					resource.TestCheckResourceAttr("data.snowflake_tables.in_schema", "schema", tableId.SchemaName()),
					resource.TestCheckResourceAttr("data.snowflake_tables.in_schema", "tables.#", "1"),
					resource.TestCheckResourceAttr("data.snowflake_tables.in_schema", "tables.0.name", tableId.Name()),
					resource.TestCheckResourceAttr("data.snowflake_tables.filtering", "database", tableId.DatabaseName()),
					...
					resource.TestCheckResourceAttr("data.snowflake_tables.filtering", "tables.0.name", tableId.Name()),
					resource.TestCheckResourceAttr("data.snowflake_tables.filtering", "tables.1.name", externalTableId.Name()),
				),
			},
		},
	})
