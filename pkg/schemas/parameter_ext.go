...
func ParameterToSchemaReducedOutput(parameter *sdk.Parameter, enabledExperiments []string) map[string]any {
	if experimentalfeatures.IsExperimentEnabled(experimentalfeatures.ParametersReducedOutput, enabledExperiments) {
