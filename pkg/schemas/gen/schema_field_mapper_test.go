...
func Test_MapToSchemaField(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: expectedValues{"unexported_string", schema.TypeString, false, false, genhelpers.Identity},
		},
		{
			field:    genhelpers.Field{Name: "unexportedInt", ConcreteType: "int", UnderlyingType: "int"},
			expected: expectedValues{"unexported_int", schema.TypeInt, false, false, genhelpers.Identity},
		},
		{
			field:    genhelpers.Field{Name: "unexportedBool", ConcreteType: "bool", UnderlyingType: "bool"},
			expected: expectedValues{"unexported_bool", schema.TypeBool, false, false, genhelpers.Identity},
		},
		{
			field:    genhelpers.Field{Name: "unexportedFloat64", ConcreteType: "float64", UnderlyingType: "float64"},
			expected: expectedValues{"unexported_float64", schema.TypeFloat, false, false, genhelpers.Identity},
		},
		{
			field:    genhelpers.Field{Name: "unexportedStringPtr", ConcreteType: "*string", UnderlyingType: "*string"},
			expected: expectedValues{"unexported_string_ptr", schema.TypeString, true, false, genhelpers.Identity},
		},
		{
			field:    genhelpers.Field{Name: "unexportedIntPtr", ConcreteType: "*int", UnderlyingType: "*int"},
			expected: expectedValues{"unexported_int_ptr", schema.TypeInt, true, false, genhelpers.Identity},
		},
		{
			field:    genhelpers.Field{Name: "unexportedBoolPtr", ConcreteType: "*bool", UnderlyingType: "*bool"},
			expected: expectedValues{"unexported_bool_ptr", schema.TypeBool, true, false, genhelpers.Identity},
		},
		{
			field:    genhelpers.Field{Name: "unexportedFloat64Ptr", ConcreteType: "*float64", UnderlyingType: "*float64"},
			expected: expectedValues{"unexported_float64_ptr", schema.TypeFloat, true, false, genhelpers.Identity},
		},
		{
			field:    genhelpers.Field{Name: "unexportedTime", ConcreteType: "time.Time", UnderlyingType: "struct"},
			expected: expectedValues{"unexported_time", schema.TypeString, false, false, genhelpers.ToString},
		},
		{
			field:    genhelpers.Field{Name: "unexportedTimePtr", ConcreteType: "*time.Time", UnderlyingType: "*struct"},
			expected: expectedValues{"unexported_time_ptr", schema.TypeString, true, false, genhelpers.ToString},
		},
		{
			field:    genhelpers.Field{Name: "unexportedStringEnum", ConcreteType: "sdk.WarehouseType", UnderlyingType: "string"},
			expected: expectedValues{"unexported_string_enum", schema.TypeString, false, false, genhelpers.CastToString},
		},
		{
			field:    genhelpers.Field{Name: "unexportedStringEnumPtr", ConcreteType: "*sdk.WarehouseType", UnderlyingType: "*string"},
			expected: expectedValues{"unexported_string_enum_ptr", schema.TypeString, true, false, genhelpers.CastToString},
		},
		{
			field:    genhelpers.Field{Name: "unexportedIntEnum", ConcreteType: "sdk.ResourceMonitorLevel", UnderlyingType: "int"},
			expected: expectedValues{"unexported_int_enum", schema.TypeInt, false, false, genhelpers.CastToInt},
		},
		{
			field:    genhelpers.Field{Name: "unexportedIntEnumPtr", ConcreteType: "*sdk.ResourceMonitorLevel", UnderlyingType: "*int"},
			expected: expectedValues{"unexported_int_enum_ptr", schema.TypeInt, true, false, genhelpers.CastToInt},
		},
		{
			field:    genhelpers.Field{Name: "unexportedAccountIdentifier", ConcreteType: "sdk.AccountIdentifier", UnderlyingType: "struct"},
			expected: expectedValues{"unexported_account_identifier", schema.TypeString, false, false, genhelpers.FullyQualifiedName},
		},
		{
			...
			expected: expectedValues{"unexported_external_object_identifier", schema.TypeString, false, false, genhelpers.FullyQualifiedName},
		},
		{
			...
			expected: expectedValues{"unexported_account_object_identifier", schema.TypeString, false, false, genhelpers.Name},
		},
		{
			...
			expected: expectedValues{"unexported_database_object_identifier", schema.TypeString, false, false, genhelpers.FullyQualifiedName},
		},
		{
			...
			expected: expectedValues{"unexported_schema_object_identifier", schema.TypeString, false, false, genhelpers.FullyQualifiedName},
		},
		{
			field:    genhelpers.Field{Name: "unexportedTableColumnIdentifier", ConcreteType: "sdk.TableColumnIdentifier", UnderlyingType: "struct"},
			expected: expectedValues{"unexported_table_column_identifier", schema.TypeString, false, false, genhelpers.FullyQualifiedName},
		},
		{
			field:    genhelpers.Field{Name: "unexportedAccountIdentifierPtr", ConcreteType: "*sdk.AccountIdentifier", UnderlyingType: "*struct"},
			expected: expectedValues{"unexported_account_identifier_ptr", schema.TypeString, true, false, genhelpers.FullyQualifiedName},
		},
		{
			...
			expected: expectedValues{"unexported_external_object_identifier_ptr", schema.TypeString, true, false, genhelpers.FullyQualifiedName},
		},
		{
			...
			expected: expectedValues{"unexported_account_object_identifier_ptr", schema.TypeString, true, false, genhelpers.Name},
		},
		{
			...
			expected: expectedValues{"unexported_database_object_identifier_ptr", schema.TypeString, true, false, genhelpers.FullyQualifiedName},
		},
		{
			...
			expected: expectedValues{"unexported_schema_object_identifier_ptr", schema.TypeString, true, false, genhelpers.FullyQualifiedName},
		},
		{
	...
	assertSchemaFieldMapped := func(schemaField SchemaField, originalField genhelpers.Field, expected expectedValues) {
		...
		assert.Equal(t, expected.isInterface, schemaField.IsOriginalTypeInterface)
