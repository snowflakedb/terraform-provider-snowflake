...
// TODO [v3]: flatten nested DescribePropertyListSchema to typed scalars + DescribeOauthPartnerDetails
// (describe_output.0.<key>.0.value → describe_output.0.<key>).
func (oauthIntegrationForPartnerApplicationsDetailsToSchemaMapper) additionalSchema() map[string]*schema.Schema {
...
func (oauthIntegrationForPartnerApplicationsDetailsToSchemaMapper) additionalToSchema(src *sdk.OauthIntegrationForPartnerApplicationsDetails, dst map[string]any) {
	if src == nil {
		return
	}
...
func DescribeOauthIntegrationForPartnerApplicationsToSchema(integrationProperties []sdk.SecurityIntegrationProperty) map[string]any {
	...
	return OauthIntegrationForPartnerApplicationsDetailsToSchema(sdk.AsOauthPartner(integrationProperties))
}
