...
func (openflowRuntimeToSchemaMapper) additionalSchema() map[string]*schema.Schema {
...
func (openflowRuntimeToSchemaMapper) additionalToSchema(src *sdk.OpenflowRuntime, dst map[string]any) {
