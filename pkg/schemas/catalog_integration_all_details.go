...
var DescribeCatalogIntegrationAllDetailsSchema = map[string]*schema.Schema{
	"id": {
...
func CatalogIntegrationAllDetailsToSchema(details *sdk.CatalogIntegrationAllDetails) map[string]any {
	out := map[string]any{
		"id":                       details.Id.Name(),
		...
		"glue_aws_role_arn":        details.GlueAwsRoleArn,
