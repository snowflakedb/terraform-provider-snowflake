...
var DescribeGitRepositoryTokenApiIntegrationSchema = map[string]*schema.Schema{
	"enabled": {
...
func ApiIntegrationGitRepositoryTokenDetailsToSchema(d *sdk.ApiIntegrationGitHttpsApiDetails) map[string]any {
