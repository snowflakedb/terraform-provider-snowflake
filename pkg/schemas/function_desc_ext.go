...
func (functionDetailsToSchemaMapper) additionalSchema() map[string]*schema.Schema {
...
func (functionDetailsToSchemaMapper) additionalToSchema(src *sdk.FunctionDetails, dst map[string]any) {
