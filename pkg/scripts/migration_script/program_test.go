...
`,
		...
		{
			name: "user with describe output fields",
			args: []string{"cmd", "-import=block", "users"},
			input: `
"name","type","login_name","display_name","first_name","middle_name","last_name","email","comment","custom_landing_page_url","custom_landing_page_url_flush_next_ui_load","mins_to_bypass_network_policy","password","password_last_set_time","rsa_public_key","rsa_public_key_fp","rsa_public_key2","rsa_public_key2_fp","snowflake_support"
"TEST_USER_DESCRIBE","PERSON","test_user_login","Test User Display","John","Michael","Doe","john.doe@example.com","User with describe fields","https://custom.landing.page","true","30","********","2025-12-03 10:00:00","RSA_KEY_1","KEY_FP_1","RSA_KEY_2","KEY_FP_2","false"`,
			expectedOutput: `resource "snowflake_user" "snowflake_generated_user_TEST_USER_DESCRIBE" {
  name = "TEST_USER_DESCRIBE"
  comment = "User with describe fields"
