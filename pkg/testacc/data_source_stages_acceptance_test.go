		...
		Steps: []resource.TestStep{
			...
			// External S3 stage with describe
			{
				...
				Check: assertThat(t,
					...
					assert.Check(resource.TestCheckResourceAttr(externalS3CompatibleStagesWithDescribe.DatasourceReference(), "stages.0.describe_output.0.location.0.url.0", awsBucketUrl)),
