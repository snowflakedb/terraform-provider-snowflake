		...
		Steps: []resource.TestStep{
			...
			// External S3 stage with describe
			{
				...
				Check: assertThat(
					...
					assert.Check(resource.TestCheckResourceAttr(externalS3StagesWithDescribe.DatasourceReference(), "stages.0.describe_output.0.location.0.aws_access_point_arn", "")),
			...
			// External S3 compatible stage with describe
			{
				...
				Check: assertThat(
					...
					assert.Check(resource.TestCheckResourceAttr(externalS3CompatibleStagesWithDescribe.DatasourceReference(), "stages.0.describe_output.0.privatelink.0.use_privatelink_endpoint", "false")),
					...
					assert.Check(resource.TestCheckResourceAttr(externalS3CompatibleStagesWithDescribe.DatasourceReference(), "stages.0.describe_output.0.location.0.aws_access_point_arn", "")),
