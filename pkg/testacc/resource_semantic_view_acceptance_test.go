			...
			// create with only required attributes
			{
				...
				Check: assertThat(t,
					...
					resourceshowoutputassert.SemanticViewShowOutput(t, modelBasic.ResourceReference()).
						...
						HasComment("").
						HasExtension(""),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.#", "12")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.4.property", "UNIQUE_KEY")),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.4.property_value", "[[\"A2\"],[\"A3\",\"A4\"]]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.5.property", "COMMENT")),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.5.property_value", "logical table 1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.6.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.6.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.7.property", "EXPRESSION")),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.7.property_value", "SUM(lt1.a1)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.8.property", "DATA_TYPE")),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.8.property_value", "NUMBER(38,0)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.9.property", "SYNONYMS")),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.9.property_value", "[\"sem1\",\"baseSem\"]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.10.property", "COMMENT")),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.10.property_value", "semantic expression 1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.11.property", "ACCESS_MODIFIER")),
					assert.Check(resource.TestCheckResourceAttr(modelBasic.ResourceReference(), "describe_output.11.property_value", "PUBLIC")),
				),
			},
			...
			// add optional attributes
			{
				...
				Check: assertThat(t,
					...
					resourceshowoutputassert.SemanticViewShowOutput(t, modelComplete.ResourceReference()).
						...
						HasComment(comment).
						HasExtension(""),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.#", "33")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.7.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.7.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.8.property", "REF_TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.8.property_value", "LT2")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.9.property", "FOREIGN_KEY")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.10.property", "REF_KEY")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.11.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.11.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.12.property", "EXPRESSION")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.12.property_value", "lt1.a1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.13.property", "DATA_TYPE")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.13.property_value", "NUMBER(38,0)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.14.property", "SYNONYMS")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.14.property_value", "[\"dim1\"]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.15.property", "COMMENT")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.15.property_value", "dimension 1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.16.property", "ACCESS_MODIFIER")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.16.property_value", "PUBLIC")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.17.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.17.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.18.property", "EXPRESSION")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.18.property_value", "lt1.a2")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.19.property", "DATA_TYPE")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.19.property_value", "NUMBER(38,0)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.20.property", "SYNONYMS")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.20.property_value", "[\"fact1\"]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.21.property", "COMMENT")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.21.property_value", "fact 1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.22.property", "ACCESS_MODIFIER")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.22.property_value", "PUBLIC")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.23.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.23.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.24.property", "EXPRESSION")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.24.property_value", "SUM(lt1.a1)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.25.property", "DATA_TYPE")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.25.property_value", "NUMBER(38,0)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.26.property", "SYNONYMS")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.26.property_value", "[\"sem1\",\"baseSem\"]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.27.property", "COMMENT")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.27.property_value", "semantic expression 1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.28.property", "ACCESS_MODIFIER")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.28.property_value", "PUBLIC")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.29.property", "BASE_TABLE_DATABASE_NAME")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.29.property_value", table2.DatabaseName)),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.30.property", "BASE_TABLE_SCHEMA_NAME")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.30.property_value", table2.SchemaName)),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.31.property", "BASE_TABLE_NAME")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.31.property_value", table2.Name)),
					...
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.32.property", "PRIMARY_KEY")),
					assert.Check(resource.TestCheckResourceAttr(modelComplete.ResourceReference(), "describe_output.32.property_value", "[\"A1\"]")),
				),
			},
			// alter
			{
				...
				Check: assertThat(t,
					...
					resourceshowoutputassert.SemanticViewShowOutput(t, modelCompleteWithDifferentValues.ResourceReference()).
						...
						HasExtension(""),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.#", "37")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.7.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.7.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.8.property", "EXPRESSION")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.8.property_value", "lt1.a2")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.9.property", "DATA_TYPE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.9.property_value", "NUMBER(38,0)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.10.property", "SYNONYMS")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.10.property_value", "[\"dim2\"]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.11.property", "COMMENT")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.11.property_value", "dimension 2")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.12.property", "ACCESS_MODIFIER")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.12.property_value", "PUBLIC")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.13.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.13.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.14.property", "EXPRESSION")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.14.property_value", "lt1.a1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.15.property", "DATA_TYPE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.15.property_value", "NUMBER(38,0)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.16.property", "SYNONYMS")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.16.property_value", "[\"fact2\"]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.17.property", "COMMENT")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.17.property_value", "fact 2")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.18.property", "ACCESS_MODIFIER")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.18.property_value", "PUBLIC")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.19.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.19.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.20.property", "EXPRESSION")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.20.property_value", "SUM(lt1.a1)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.21.property", "DATA_TYPE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.21.property_value", "NUMBER(38,0)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.22.property", "SYNONYMS")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.22.property_value", "[\"sem1\",\"baseSem\"]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.23.property", "COMMENT")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.23.property_value", "semantic expression 1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.24.property", "ACCESS_MODIFIER")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.24.property_value", "PUBLIC")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.25.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.25.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.26.property", "EXPRESSION")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.26.property_value", "sum(lt1.se1) OVER (PARTITION BY lt1.d2)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.27.property", "DATA_TYPE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.27.property_value", "NUMBER(38,0)")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.28.property", "ACCESS_MODIFIER")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.28.property_value", "PUBLIC")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.29.property", "BASE_TABLE_DATABASE_NAME")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.29.property_value", table2.DatabaseName)),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.30.property", "BASE_TABLE_SCHEMA_NAME")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.30.property_value", table2.SchemaName)),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.31.property", "BASE_TABLE_NAME")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.31.property_value", table2.Name)),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.32.property", "PRIMARY_KEY")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.32.property_value", "[\"A1\"]")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.33.property", "TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.33.property_value", "LT2")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.34.property", "REF_TABLE")),
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.34.property_value", "LT1")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.35.property", "FOREIGN_KEY")),
					...
					assert.Check(resource.TestCheckResourceAttr(modelCompleteWithDifferentValues.ResourceReference(), "describe_output.36.property", "REF_KEY")),
