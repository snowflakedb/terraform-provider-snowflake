...
var allObjectsParameters = []SnowflakeObjectParameters{
	...
	},
	{
		...
		Parameters: []SnowflakeParameter{
			...
			{ParameterName: string(sdk.TaskParameterServerlessTaskMaxStatementSize), ParameterType: "string", DefaultValue: "X2Large", DefaultLevel: "sdk.ParameterTypeSnowflakeDefault"},
			{ParameterName: string(sdk.TaskParameterServerlessTaskMinStatementSize), ParameterType: "string", DefaultValue: "XSMALL", DefaultLevel: "sdk.ParameterTypeSnowflakeDefault"},
