...
func (c *ComputePoolDetailsAssert) HasBackupInstanceFamilies(expected ...string) *ComputePoolDetailsAssert {
	c.AddAssertion(func(t *testing.T, o *sdk.ComputePoolDetails) error {
		t.Helper()
...
func (c *ComputePoolDetailsAssert) HasNoBackupInstanceFamilies() *ComputePoolDetailsAssert {
	c.AddAssertion(func(t *testing.T, o *sdk.ComputePoolDetails) error {
		t.Helper()
