...
func (e *ExternalOauthSecurityIntegrationResourceAssert) HasNoExternalOauthTokenUserMappingClaim() *ExternalOauthSecurityIntegrationResourceAssert {
	e.AddAssertion(assert.ValueSet("external_oauth_token_user_mapping_claim.#", "0"))
	return e
}
...
func (e *ExternalOauthSecurityIntegrationResourceAssert) HasExternalOauthAllowedRolesListNotEmpty() *ExternalOauthSecurityIntegrationResourceAssert {
	e.AddAssertion(assert.ValuePresent("external_oauth_allowed_roles_list"))
	return e
}
...
func (e *ExternalOauthSecurityIntegrationResourceAssert) HasExternalOauthAudienceListNotEmpty() *ExternalOauthSecurityIntegrationResourceAssert {
	e.AddAssertion(assert.ValuePresent("external_oauth_audience_list"))
	return e
}

func (e *ExternalOauthSecurityIntegrationResourceAssert) HasExternalOauthBlockedRolesListNotEmpty() *ExternalOauthSecurityIntegrationResourceAssert {
	e.AddAssertion(assert.ValuePresent("external_oauth_blocked_roles_list"))
	return e
}
...
func (e *ExternalOauthSecurityIntegrationResourceAssert) HasExternalOauthJwsKeysUrlNotEmpty() *ExternalOauthSecurityIntegrationResourceAssert {
	e.AddAssertion(assert.ValuePresent("external_oauth_jws_keys_url"))
	return e
}
...
func (e *ExternalOauthSecurityIntegrationResourceAssert) HasExternalOauthTokenUserMappingClaimNotEmpty() *ExternalOauthSecurityIntegrationResourceAssert {
	e.AddAssertion(assert.ValuePresent("external_oauth_token_user_mapping_claim"))
	return e
}
...
func (e *ExternalOauthSecurityIntegrationResourceAssert) HasRelatedParametersNotEmpty() *ExternalOauthSecurityIntegrationResourceAssert {
	e.AddAssertion(assert.ValuePresent("related_parameters"))
	return e
}
