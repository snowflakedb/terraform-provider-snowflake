...
func (g *GrantApplicationRoleResourceAssert) HasApplicationName(expected string) *GrantApplicationRoleResourceAssert {
	g.StringValueSet("application_name", expected)
	return g
}

func (g *GrantApplicationRoleResourceAssert) HasApplicationRoleName(expected string) *GrantApplicationRoleResourceAssert {
	g.StringValueSet("application_role_name", expected)
	return g
}

func (g *GrantApplicationRoleResourceAssert) HasParentAccountRoleName(expected string) *GrantApplicationRoleResourceAssert {
	g.StringValueSet("parent_account_role_name", expected)
	return g
}
...
func (g *GrantApplicationRoleResourceAssert) HasApplicationNameString(expected string) *GrantApplicationRoleResourceAssert {
	g.ValueSet("application_name", expected)
	return g
}
...
func (g *GrantApplicationRoleResourceAssert) HasApplicationRoleNameString(expected string) *GrantApplicationRoleResourceAssert {
	g.ValueSet("application_role_name", expected)
	return g
}
...
func (g *GrantApplicationRoleResourceAssert) HasParentAccountRoleNameString(expected string) *GrantApplicationRoleResourceAssert {
	g.ValueSet("parent_account_role_name", expected)
	return g
}
