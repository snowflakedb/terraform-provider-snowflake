...
func (s *Saml2SecurityIntegrationResourceAssert) HasAllowedEmailPatternsNotEmpty() *Saml2SecurityIntegrationResourceAssert {
	s.AddAssertion(assert.ValuePresent("allowed_email_patterns"))
	return s
}

func (s *Saml2SecurityIntegrationResourceAssert) HasAllowedUserDomainsNotEmpty() *Saml2SecurityIntegrationResourceAssert {
	s.AddAssertion(assert.ValuePresent("allowed_user_domains"))
	return s
}
