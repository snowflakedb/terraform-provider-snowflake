...
func (s *IcebergTablesModel) WithInSchema(schemaId sdk.DatabaseObjectIdentifier) *IcebergTablesModel {
	return s.WithInValue(
		tfconfig.ObjectVariable(map[string]tfconfig.Variable{
...
func (s *IcebergTablesModel) WithLimit(rows int) *IcebergTablesModel {
