...
func (a *ApiIntegrationAmazonApiGatewayModel) WithApiAllowedPrefixes(apiAllowedPrefixes []string) *ApiIntegrationAmazonApiGatewayModel {
...
func (a *ApiIntegrationAmazonApiGatewayModel) WithApiBlockedPrefixes(apiBlockedPrefixes []string) *ApiIntegrationAmazonApiGatewayModel {
