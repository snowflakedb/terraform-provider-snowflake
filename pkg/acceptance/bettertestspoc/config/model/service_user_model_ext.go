...
func (u *ServiceUserModel) WithLogEventLevelEnum(logEventLevel sdk.LogLevel) *ServiceUserModel {
...
func (u *ServiceUserModel) WithDefaultWorkloadIdentityAws(arn string, issuer ...string) *ServiceUserModel {
