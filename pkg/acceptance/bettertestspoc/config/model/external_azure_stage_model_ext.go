...
func (e *ExternalAzureStageModel) WithDirectoryEnabledAndOptions(enable bool, refreshOnCreate, autoRefresh string) *ExternalAzureStageModel {
	...
	if autoRefresh != "" {
		directoryMap["auto_refresh"] = tfconfig.StringVariable(autoRefresh)
	}
