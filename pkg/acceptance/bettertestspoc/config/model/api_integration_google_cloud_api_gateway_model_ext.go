...
func (a *ApiIntegrationGoogleCloudApiGatewayModel) WithApiAllowedPrefixes(apiAllowedPrefixes []string) *ApiIntegrationGoogleCloudApiGatewayModel {
...
func (a *ApiIntegrationGoogleCloudApiGatewayModel) WithApiBlockedPrefixes(apiBlockedPrefixes []string) *ApiIntegrationGoogleCloudApiGatewayModel {
