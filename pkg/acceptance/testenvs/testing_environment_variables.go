...
const (
	...
	// Oauth-related
	OauthClientId        env = envPrefix + "OAUTH_CLIENT_ID"
	OauthClientSecret    env = envPrefix + "OAUTH_CLIENT_SECRET"
	OauthTokenRequestUrl env = envPrefix + "OAUTH_TOKEN_REQUEST_URL"
)
