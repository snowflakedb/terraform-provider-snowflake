...
const (
	...
	// NonProdModifiableAccountLocator represents an account locator that can be used for account modification tests.
	// It's used in XXX to conditionally skip tests that require a modifiable account.
	NonProdModifiableAccountLocator env = "TEST_SF_TF_NON_PROD_MODIFIABLE_ACCOUNT_LOCATOR"
