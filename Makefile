...
# EventTables (ClusterBy builder bug), HybridTables (imports.Process tooling issue with 'type' keyword),
...
SDK_DTO_OBJECTS := ApiIntegrations,ApplicationPackages,ApplicationRoles,Applications,AuthenticationPolicies,Budgets,CatalogIntegrations,ComputePools,Connections,CortexAgents,CortexSearchServices,DataMetricFunctionReferences,ExternalFunctions,ExternalVolumes,FileFormats,Functions,GitRepositories,IcebergTables,ImageRepositories,Listings,ManagedAccounts,MaterializedViews,NetworkPolicies,NetworkRules,NotificationIntegrations,OpenflowConnectors,OpenflowDeployments,OpenflowRuntimes,OrganizationAccounts,PasswordPolicies,RowAccessPolicies,Secrets,SecurityIntegrations,Sequences,Services,SessionPolicies,Stages,StorageIntegrations,StorageLifecyclePolicies,Streamlits,Streams,TagReferences,UserProgrammaticAccessTokens,Views
