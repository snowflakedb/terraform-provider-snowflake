...
test-acceptance: ## run acceptance tests
	...
	TF_ACC=1 SF_TF_ACC_TEST_CONFIGURE_CLIENT_ONCE=true TEST_SF_TF_REQUIRE_TEST_OBJECT_SUFFIX=1 TEST_SF_TF_REQUIRE_GENERATED_RANDOM_VALUE=1 SF_TF_ACC_TEST_ENABLE_ALL_PREVIEW_FEATURES=true SNOWFLAKE_USE_LEGACY_TOML_FILE=true go test -timeout 600s -run "^TestAcc_Provider_LegacyTomlConfig" github.com/Snowflake-Labs/terraform-provider-snowflake/pkg/provider -v
