...
SHOW_OUTPUT_SCHEMAS_EXCLUDE ?= sdk.AuthenticationPolicy,sdk.CatalogIntegrationAwsGlueDetails,sdk.CatalogIntegrationObjectStorageDetails,sdk.ComputePool,sdk.Connection,sdk.Database,sdk.DynamicTable,sdk.Function,sdk.GitRepository,sdk.HybridTableConstraint,sdk.IcebergTable,sdk.Listing,sdk.ManagedAccount,sdk.MaskingPolicy,sdk.MaterializedView,sdk.Notebook,sdk.OpenflowConnectorDefinition,sdk.OpenflowRuntime,sdk.PolicyReference,sdk.Procedure,sdk.ProgrammaticAccessToken,sdk.ReplicationAccount,sdk.ResourceMonitor,sdk.Schema,sdk.Secret,sdk.Service,sdk.SessionPolicy,sdk.SessionPolicyDetails,sdk.Share,sdk.Stage,sdk.StorageIntegrationAllDetails,sdk.StorageIntegrationAwsDetails,sdk.StorageIntegrationAzureDetails,sdk.StorageIntegrationGcsDetails,sdk.Stream,sdk.Table,sdk.Tag,sdk.Task,sdk.Warehouse
